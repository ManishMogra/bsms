		...
		<div class="row">
			...
			<div class="col-md-6 text-center p-5 border bg-white">
				...
				<h5 class="text-primary">
					<i class="far fa-envlope"></i> Email:
					<%=b.getEmail()%></h5>
				<%
					}
				%>
				...
				<div class="text-center p-3">
					<a href="index.jsp" class="btn btn-success"><i
						class=fasfa-cart-plus"></i> Continue Shopping</a> <a href=""
				...
				%>
				<div class="text-center p-3">
					<a href="" class="btn btn-primary"><i class=fasfa-cart-plus"></i>
						AddCart</a> <a href="" class="btn btn-danger"><i
